...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(bg.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
						...
						<div class="col-md-8">
							...
							<?php
								...
								<?php else: ?>
									...
									<a class="main-button icon-button" href="\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\career-quiz-master\index.html">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Caristography</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Caristography</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									<a href="\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\career-quiz-master\index.html"><h4>Career Prediction</h4></a>
		...
		<div id="cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(bg1.jpg)"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-6">
							...
							<?php
								...
								<p class="lead white-text" >We Create Beautiful Experiences
									That Drive Successful Careers.</p>
									<a class="main-button icon-button" href="index.php">Get Started!</a>

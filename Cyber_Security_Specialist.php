				...
				<div class="row">
					...
					<div id="index" class="col-md-9">
                        ...
                        <h2>Job Description</h2>
							...
							<p style="font-size:16px;">The Cyber Security Specialist assists in designing and developing security features for system architectures. They have to play an active role in developing special purpose systems necessary for specialized security features and procedures. The specialist defines security requirements for computer systems such as indexframes, workstation, and personal computers. They have to suggest various solutions and implement them to meet the security requirements.</p>
